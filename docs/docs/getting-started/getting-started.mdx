...
And on you will continue for each verse. You see the pattern now. The prompt is the previous verse. That's what the app will show you to help remind you of the next verse that you're trying to quote.
