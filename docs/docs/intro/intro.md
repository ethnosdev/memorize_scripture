...
:::important
This tutorial was written for Memorize Scripture version 1.4. You can check your installed version number by going to the app menu and choosing **About**. If you're using a lower version, you should upgrade. The store links are below:
