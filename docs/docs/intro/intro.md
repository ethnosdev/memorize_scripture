...
:::important
This tutorial was written for Memorize Scripture version 2.0. You can check your installed version number by going to the app menu and choosing **About**. If you want to manually upgrade, the store links are below:
