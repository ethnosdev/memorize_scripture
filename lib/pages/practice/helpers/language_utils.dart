...
/// Punctuation that attaches to the NEXT word (Opening quotes, parentheses, dashes, etc.)
bool isPrefixPunctuation(String char) => _prefixRegex.hasMatch(char);

/// Punctuation that attaches to the PREVIOUS word (Closing quotes, period, comma, dashes, etc.)
